...
f, axes = plt.subplots(20, 20, figsize=(15, 15), sharex=False)
axes = axes.ravel()
i = 0
for ax in axes:
   ...
   #ref_act = np.load('examples/classifier_compression/test/kldiv_q_act_'+str(i)+'_32.npy')
   ref_act = np.load('examples/classifier_compression/fmaps0/q_act_'+str(i*10)+'.npy')
...
plt.savefig('feature_maps/test.png')
#plt.savefig('feature_maps/kldiv_all_e32.png')
